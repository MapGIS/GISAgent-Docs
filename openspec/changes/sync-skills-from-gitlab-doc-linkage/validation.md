...
- 已确认 `doc/update.md` 的固定来源已从 `clis/` + `gisagent/` 扩展为 `clis/` + `gisagent/` + `skills/`
- 已确认 `gisagent` 固定来源已从 `CHANGELOG.md` 改为 Git log
- 已确认存在可执行脚本 `doc/scripts/generate_skill_update.py`
